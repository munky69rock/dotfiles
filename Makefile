...
config:
	...
	ln -s $(PREFIX)/git/dotfiles/vim             $(PREFIX)/.vim
	ln -s $(PREFIX)/git/dotfiles/vim/vimrc       $(PREFIX)/.vimrc
	ln -s $(PREFIX)/git/dotfiles/zsh/zshrc       $(PREFIX)/.zshrc
	ln -s $(PREFIX)/git/dotfiles/screen/screenrc $(PREFIX)/.screenrc
	ln -s $(PREFIX)/git/dotfiles/tmux/tmux.conf  $(PREFIX)/.tmux.conf
